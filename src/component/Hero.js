        ...
        <div className="justify-center text-center gap-6 md:text-left md:flex lg:items-center  lg:gap-16">
            <div className="order-last mb-6 space-y-6 md:mb-0 md:w-6/12 lg:w-6/12">
                ...
                <div className="flex flex-row-reverse flex-wrap justify-center gap-4 md:gap-6 md:justify-end">
                    ...
                    <button type="button" title="more about" className="w-full order-first py-3 px-6 text-center rounded-xl bg-red-300 transition hover:bg-red-500 active:bg-gray-300 focus:bg-gray-200 sm:w-max">
                        <span className="block gray-100 font-semibold">
                            Youtube Channel
                        </span>
                    </button>
                </div>
